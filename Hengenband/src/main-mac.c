 ...
 */
#define PREF_FILE_NAME _("Hengenband Preferences", "Hengenband-E Preferences")
...
static void init_stuff(void)
{
	...
	while (1)
	{
		...
		/* Warning */
		plog(_("Hengenbandの'lib'フォルダが存在しないか正しく無い可能性があります.", "The Angband 'lib' folder is probably missing or misplaced."));
