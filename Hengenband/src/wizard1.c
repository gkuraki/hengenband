...
static void spoil_obj_desc(cptr fname)
{
	...
	/* Header */
	fprintf(fff, "Spoiler File -- Basic Items (Hengenband %d.%d.%d.%d)\n\n\n",
...
static void print_header(void)
{
	...
	sprintf(buf, "Artifact Spoilers for Hengenband Version %d.%d.%d",
...
static void spoil_mon_desc(cptr fname)
{
	...
	/* Dump the header */
	fprintf(fff, "Monster Spoilers for Hengenband Version %d.%d.%d\n",
		FAKE_VER_MAJOR-10, FAKE_VER_MINOR, FAKE_VER_PATCH);
	fprintf(fff, "------------------------------------------\n\n");
...
static void spoil_mon_info(cptr fname)
{
	...
	/* Dump the header */
	sprintf(buf, "Monster Spoilers for Hengenband Version %d.%d.%d\n",
	     FAKE_VER_MAJOR-10, FAKE_VER_MINOR, FAKE_VER_PATCH);
